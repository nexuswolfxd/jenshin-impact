...
int dupe_check(FILE *player_data, char temp_username[], char temp_password[]);
...
int create_account(FILE *player_data)
{
    ...
    check = dupe_check(player_data, temp_username, temp_password);
...
int dupe_check(FILE *player_data, char temp_username[10], char temp_password[10])
{
    user_info atemp[MAX];
